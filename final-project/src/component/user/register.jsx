                ...
                <div className="flex items-center justify-center place-content-center mx-0 my-20">
                    <div className="w-full max-w-xl p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700">
                        <form className="space-y-6" action="#">
                            <h5 className="text-4xl font-bold text-gray-900 dark:text-white">Daftar</h5>
                            <div className="">
                            ...
                            <div className="flex items-start">
                                <div className="flex items-start">
                                    <div className="flex items-center h-5">
                                        <input id="remember" type="checkbox" value="" className="mt-2.5 w-5 h-5 border border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-blue-300 dark:bg-gray-700 dark:border-gray-600 dark:focus:ring-blue-600 dark:ring-offset-gray-800 dark:focus:ring-offset-gray-800" required />
                                    </div>
                                    <label htmlFor="terms" className="ms-2 text-lg font-medium text-gray-900 dark:text-gray-300">Saya setuju dengan Syarat & Ketentuan</label>
                                </div>
                                {/* <a href="#" className="ms-auto text-lg text-black hover:text-black hover:underline dark:text-blue-500">Lupa kata sandi?</a> */}
                            </div>
                            <button type="submit" className="w-full text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-lg px-5 py-2.5 text-center dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800">Masuk</button>
                            ...
                            <div className="text-lg font-medium text-black dark:text-gray-300">
                                Sudah punya akun? <a href="/login" className="text-black hover:text-black hover:underline dark:text-blue-500">Masuk</a>
                            </div>
                            ...
                            <button type="submit" className="w-full text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-lg px-5 py-2.5 text-center dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800">Masuk untuk Admin</button>
                        </form>
                    </div>
                </div>
            </main>
