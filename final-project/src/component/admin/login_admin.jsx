                ...
                <div className="flex items-center justify-center place-content-center mx-0 my-20">
                    <div className="w-full max-w-xl p-4 bg-white border border-gray-200 rounded-lg shadow sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700">
                        <form className="space-y-6" action="#">
                            <h5 className="text-4xl font-bold text-gray-900 dark:text-white">Masuk Admin</h5>
                            <div className="">
                            ...
                            <a href='/dashboard'>
                                <button type="submit" onClick={handleAdminLogin} className="w-full text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-lg px-5 py-2.5 text-center dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800">Masuk</button>
                            </a>
                            ...
                            <a href="/dashboard">
                                <button type="button" onClick={handleAdminLogin} className="mt-5 w-full text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-lg px-5 py-2.5 text-center dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800">Masuk untuk Admin</button>
                            </a> */}
                        </form>
                    </div>
                </div>
